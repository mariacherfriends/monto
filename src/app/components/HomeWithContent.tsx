...
function Ticker() {
  return (
    <div
      data-name="slider"
      className="flex gap-[80px] items-center whitespace-nowrap font-['Waverly_CF:Extra_Bold',sans-serif] text-[#8d8e8e] text-[20px] tracking-[3px] uppercase not-italic leading-[normal]"
    >
