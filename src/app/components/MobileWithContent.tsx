...
function Ticker() {
  return (
    <div
      data-name="slider"
      className="flex gap-[80px] items-start whitespace-nowrap font-['Waverly_CF:Extra_Bold',sans-serif] text-[#8d8e8e] text-[18px] tracking-[2.7px] uppercase not-italic leading-[normal]"
    >
